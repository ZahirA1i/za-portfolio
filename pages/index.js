...
const Page = () => {
    return (
        ...
        <Paragraph>Hi, my name is Zahir and I'm 21 years old, born and raised in Vancouver, BC. I have a passion for design and a keen eye for detail, which allows me to create visually stunning and effective designs for a variety of mediums. My education in graphic design and my ongoing professional development have provided me with a strong foundation in design principles, typography, colour theory, and software tools. I am highly motivated, organized, and able to work collaboratively or independently with clients and team members to deliver projects on time and within budget</Paragraph>
